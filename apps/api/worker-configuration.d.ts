/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: acc37abe93a970a700232bd3f73b6d0a)
// Runtime types generated with workerd@1.20260828.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	MEDIA_BUCKET: R2Bucket;
	CLERK_PUBLISHABLE_KEY: "pk_test_bGl2aW5nLWthbmdhcm9vLTE5MjAuY2xlcmsuYWNjb3VudHMuZGV2JA";
	API_BASE_URL: "https://stay-in-touch-api.lara-sheard9.workers.dev";
	DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_PUBLISHABLE_KEY" | "API_BASE_URL" | "DATABASE_URL" | "CLERK_SECRET_KEY" | "RESEND_API_KEY">> {}
}
